...
function usePagination(items, config) {
    ...
    var _c = useState(1), curPage = _c[0], setCurPage = _c[1];
...
var Pagination = function (props) {
    ...
    return (React.createElement("div", { className: classes.root },
        React.createElement(Button, { variant: "text", onClick: function () { return onPageChange(currentPage - 1); } }, "prev"),
...
var EmailConfig = function (props) {
    ...
    return (React.createElement(Box, null,
        React.createElement(Typography, { gutterBottom: true }, "Configure email"),
        React.createElement(Box, { display: "flex", flexDirection: "column" },
            React.createElement(Box, { my: 2 },
                React.createElement(Typography, null, "To: "),
                React.createElement(Box, { width: "100%" },
                    React.createElement(Input, { value: to, fullWidth: true, onChange: function (e) { return setTo(e.target.value); } }))),
            React.createElement(Box, { my: 2 },
                React.createElement(Typography, null, "CC: "),
                React.createElement(Box, { display: "flex", flexDirection: "column" },
                    cc.map(function (_cc, i) { return (React.createElement(Box, { my: 1, key: i, display: "flex", width: "100%" },
                        React.createElement(Input, { fullWidth: true, value: cc[i] || '', onChange: function (e) {
                                setCc(__spreadArrays(cc.map(function (_, _i) { return i === _i ? e.target.value : _; })));
                            } }),
                        React.createElement(IconButton, { style: { padding: 0 }, onClick: function () { return setCc(__spreadArrays(cc.filter(function (_, _i) { return i !== _i; }))); } },
                            React.createElement("i", { className: "material-icons" }, "clear")))); }),
                    React.createElement(Box, { width: "50px", my: 1, height: "50px" },
...
var SmsConfig = function (props) {
    ...
    return (React.createElement(Box, null,
        React.createElement(Typography, { gutterBottom: true }, "Configure SMS"),
        React.createElement(Box, { display: "flex", flexDirection: "column" },
            React.createElement(Box, { my: 2 },
                React.createElement(Typography, null, "to: "),
                React.createElement(Box, { display: "flex", flexDirection: "column" },
                    numbers.map(function (number, i) { return (React.createElement(Box, { my: 1, key: i, display: "flex", width: "100%" },
                        React.createElement(Input, { placeholder: "+918800000000", fullWidth: true, value: numbers[i] || '', onChange: function (e) {
                                setNumbers(__spreadArrays(numbers.map(function (_, _i) { return i === _i ? e.target.value : _; })));
                            } }),
                        React.createElement(IconButton, { style: { padding: 0 }, onClick: function () { return setNumbers(__spreadArrays(numbers.filter(function (_, _i) { return i !== _i; }))); } },
                            React.createElement("i", { className: "material-icons" }, "clear")))); }),
                    React.createElement(Box, { width: "50px", my: 1, height: "50px" },
...
var TestTemplate = function (props) {
    ...
    return (React.createElement(Paper, null,
        React.createElement(Box, { p: 3, width: "300px" },
    ...
    return (React.createElement("div", { className: classes.root },
        React.createElement(Box, { ml: 1 },
            React.createElement(Typography, { variant: "caption" },
                React.createElement("b", null, "INSERT VARIABLE"))),
...
var Heading = (React.createElement("span", { className: "ql-formats" },
    React.createElement("select", { className: "ql-header", defaultValue: "" },
        ...
        React.createElement("option", { value: "" }, "Normal"))));
var Size = (React.createElement("select", { className: "ql-size", defaultValue: "16px" },
    React.createElement("option", { value: "34px" }, "Heading 1"),
    React.createElement("option", { value: "24px" }, "Heading 2"),
    React.createElement("option", { value: "20px" }, "Heading 3"),
    React.createElement("option", { value: "16px" }, "Body 1"),
    React.createElement("option", { value: "14px" }, "Body 2"),
    React.createElement("option", { value: "11px" }, "Body 3")));
...
var Attachments = function (props) {
    ...
    return (React.createElement(Box, null,
        ...
        React.createElement(Box, { display: "flex", flexDirection: "column" },
            attachments.map(function (a, index) { return (React.createElement(Box, { key: a.id, display: "flex", width: "100%", justifyContent: "space-between", alignItems: "center", my: 2 },
            ...
            selectedAttachmentFields.map(function (a) { return (React.createElement(Box, { key: a.value, display: "flex", width: "100%", justifyContent: "space-between", alignItems: "center", my: 2 },
    ...
    return (React.createElement("div", null,
        React.createElement(Paper, null,
            React.createElement(Box, { p: 3, display: "flex", alignItems: "center" }, step === 1 ? (React.createElement(FormControl, { fullWidth: true },
                React.createElement(InputLabel, null,
                    ...
                    template.channel,
                    " type"),
                React.createElement(Select, { name: "flow", value: template.flow || '', onChange: _handleChange }, FLOWS.map(function (flow) { return (React.createElement(MenuItem, { key: flow.value, value: flow.value }, flow.name)); })))) : (React.createElement(Box, { display: "flex", alignItems: "center" },
                config.singleInstances ? null : (React.createElement(IconButton, { onClick: function () { return setStep(1); } },
        ...
        props.template.channel === 'email' ? (React.createElement(React.Fragment, null,
            ...
            React.createElement(Paper, __assign({ elevation: 1, className: classes.container }, dialogProps.formContainerProps),
                ...
                React.createElement(Box, { display: "flex", flexDirection: "column" },
                    EMAIL_INPUT_CONFIG.map(function (config, i) { return (React.createElement(Box, { my: 2, key: config.name + i, width: "100%" },
                        React.createElement(FormControl, { fullWidth: true },
                            React.createElement(TextField, { error: !!errors[config.name], label: config.label, required: config.required, multiline: config.multiline || false, name: config.name, value: config.value, onChange: config.handleChange })))); }),
...
var MainTabs = function (props) {
    ...
    return (React.createElement(AppBar, { position: "sticky" },
        React.createElement(Toolbar$1, { className: classes.toolbar },
            ...
            React.createElement(Tabs, { value: props.tabValue, onChange: function (_, tab) { return props.onTabChange(tab); } },
                React.createElement(Tab, { label: "All" }),
