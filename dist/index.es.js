...
import { makeStyles, createStyles, Paper, Box, Typography, Button, LinearProgress, Fab, FormControl, InputLabel, Input, Dialog, AppBar, Toolbar as Toolbar$1, CircularProgress, Slide } from '@material-ui/core';
...
var Form = function (props) {
    ...
    var handleRteChange = function (content) {
    ...
    return (React__default.createElement(Paper, __assign({ elevation: 1, className: classes.root }, dialogProps.formContainerProps),
        React__default.createElement(Box, { display: "flex", flexDirection: "column" },
            INPUT_CONFIG.map(function (config) { return (React__default.createElement(Box, { my: 2, key: config.name, width: "100%" },
            ...
            React__default.createElement(Box, { my: 2, width: "100%" },
                React__default.createElement(Typography, { variant: "caption" }, "EMAIL BODY"),
                React__default.createElement(lib, { className: classes.rte, value: ((_b = template.email) === null || _b === void 0 ? void 0 : _b.body) || '', onChange: handleRteChange })))));
};
...
function Transition(props) {
    return React__default.createElement(Slide, __assign({ direction: "up" }, props));
}
var AddEditDialog = function () {
    ...
    return (React__default.createElement(Dialog, { open: dialogOpen, TransitionComponent: Transition, PaperProps: { className: classes.root }, onClose: closeDialog, fullScreen: true },
        React__default.createElement(AppBar, __assign({}, dialogProps.toolbarProps),
            React__default.createElement(Toolbar$1, null,
                ...
                React__default.createElement(Box, { display: "flex", alignItems: "center" },
                    React__default.createElement(Box, { mr: 2 },
