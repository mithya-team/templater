...
function SingleImageUpload(props) {
    ...
    return props.loading ? React__default.createElement(core.Typography, { align: "center" },
        ...
        React__default.createElement("div", { className: classes.buttonContainer, style: { top: !!props.imageUrl ? undefined : '50%' } },
            ...
            React__default.createElement(core.Fab, { size: "small", color: "primary", className: classes.uploadBtn, style: mini ? { width: 30, height: 30, minHeight: 0, opacity: !!props.imageUrl ? 0 : 1 } : {} },
...
var useStyles$e = styles.makeStyles(function (theme) { return styles.createStyles({
    rte: {
        '& .ql-editor': {
            minHeight: 160
        }
