...
var AddEditDialog = function () {
    ...
    return selectedTemplate ? (React__default.createElement(core.Dialog, { open: dialogOpen, PaperProps: { className: classes.root }, onClose: closeDialog, fullScreen: true },
        React__default.createElement(core.AppBar, __assign({}, config.dialogToolbarProps),
            React__default.createElement(core.Toolbar, null,
                ...
                React__default.createElement(core.Box, null,
                    React__default.createElement(core.Button, { onClick: closeDialog }, "Cancel"),
                    React__default.createElement(core.Button, { onClick: handleSubmit, variant: "contained", color: "primary" }, status === 'loading' ? React__default.createElement(core.CircularProgress, null) : 'Submit')))),
        React__default.createElement(core.Box, { margin: "100px auto", p: "20px", width: "600px" },
